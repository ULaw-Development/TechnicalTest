...
namespace ULaw.ApplicationProcessor.Tests
{
    ...
    public class ApplicationSubmissionTests
    {
        ...
        public void Setup() 
        {
            ...
            thisSubmission = new Application( _application, new TemplateBuilderFactory() ); 
            // could set this up via a DI framework, or mock it to check correct template class was used
        }
